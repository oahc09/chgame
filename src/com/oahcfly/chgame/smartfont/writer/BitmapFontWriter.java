...
package com.oahcfly.chgame.smartfont.writer;
...
public class BitmapFontWriter {
    ...
    public static void writeFont(BitmapFontData fontData, String[] pageRefs, FileHandle outFntFile, FontInfo info,
        ...
        buf.append(xmlOpen).append("common lineHeight=").append(quote(lineHeight)).append(" base=").append(quote(base))
                ...
                .append(quote(pages)).append(" packed=").append(quote(packed)).append(alphaChnlParams)
            ...
            for (int j = 0; j < glyphs.size; j++) {
                ...
                if (kern != 0) {
                    ...
                    kernBuf.append(xmlTab).append(xmlOpen).append("kerning first=").append(quote(first.id))
                            .append(" second=").append(quote(second.id)).append(" amount=").append(quote(kern, true))
                            .append(xmlCloseSelf).append("\n");
                }
            }
        }
